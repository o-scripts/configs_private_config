#!/bin/bash
## global settings
ENV_URL="git@github.com:o-scripts/configs_private_config_env.git"
ENV_LOCAL="env"
COMMAND_URL="https://github.com/o-scripts/configs_private_config_command.git"
COMMAND_LOCAL="command"
ZSH_URL="https://github.com/o-scripts/oh-my-zsh.git"
ZSH_LOCAL="oh-my-zsh"
BASH_URL="https://github.com/o-scripts/oh-my-bash.git"
BASH_LOCAL="oh-my-bash"
VIM_URL="https://github.com/o-scripts/spf13-vim.git"
